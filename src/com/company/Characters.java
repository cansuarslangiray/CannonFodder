...
*/
    ...
    public ArrayList<Player> wizardArrayList = new ArrayList<>();
 ...
 */
    public ArrayList<Player> yourCharacters(){
       ...
       // arr.get(0).get(0).getWeapons().
        arr.add(wizardArrayList);
        arr.add(worrierArrayList);
        arr.add(elfArrayList);
        arr.add(knightArrayList);
        arr.add(lancerArrayList);
/*
        arr.add(worriersGet());
        arr.add(wizardsGet());
        arr.add(elfGet());
